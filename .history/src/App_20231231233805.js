...
export default function App() {
    ...
    function handleSaveClick(id, event) {
        ...
        setAllData((prevData) => {
            return prevData.map(cardData => {
                if (cardData.id === id) {
                    const { editProvince, editCity, editDesc } = cardData;
                    return {
                        ...cardData,
                        province: editProvince,
                        city: editCity,
                        desc: editDesc,
                        editProvince: cardData.province,
                        editCity: cardData.city,
                        editDesc: cardData.desc,
                        showEditMenu: false,
                    }
                    alert("The province is now: " + cardData.province);
                    alert("The editProvince is now: " + cardData.editProvince);
                }
                else {
                    return cardData;
                }
